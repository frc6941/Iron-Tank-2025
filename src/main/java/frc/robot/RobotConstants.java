...
public class RobotConstants {
    ...
    public static class IntakeConstants {
        ...
        public static class IntakeMovePivotPID {
            public static final TunableNumber kP = new TunableNumber("INTAKE_MOVE_PID/Pivot/KP", 40);
            public static final TunableNumber kI = new TunableNumber("INTAKE_MOVE_PID/Pivot/KI", 0.0);
            public static final TunableNumber kD = new TunableNumber("INTAKE_MOVE_PID/Pivot/KD", 2.5);
